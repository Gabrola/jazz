...
- [**discriminable-typescript-errors**](todo/issues/discriminable-typescript-errors.md) — The TypeScript API currently throws too many plain, message-only `Error`s, so app code cannot reliably distinguish
